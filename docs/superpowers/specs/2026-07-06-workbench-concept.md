...
- **Mockups (interactive):**
  - Workbench (current model): https://claude.ai/code/artifact/a6dc2447-7b07-4303-9543-4aaf9ca67490
  - Readwise-only increments (the *earlier*, now-superseded framing): https://claude.ai/code/artifact/880b3b63-106b-45f6-917e-221cd7e521a2
- **Supersedes (conceptually):** the Inc-2..5 sketches in `2026-07-05-readwise-roadmap.md` §8. Those remain valid as *Readwise-specific value*, but the mechanism is now horizontal.
